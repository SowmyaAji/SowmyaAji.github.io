...
if (z === x || z === y) {
  console.log("Z is equal to X or Y: " + z + " " + "X: " + x + " Y: " + y);
  z = getRandomInt(20);
  console.log(`New Z: ${z}`);
}
console.log("We are the variables: {" + x + " " + y + " " + z + "}");
...
let number6 = (number - z) * x - (number1 - z) * y;
let number7 = (number - z) * x + (number1 - z) * y;
let number8 = number * z * x + number1 * z * y;
let number9 = number * z * x - number1 * z * y;

let eq1Text = [
  `${number}x + ${number1}y = ${number2}`,
  `${number + z}x - ${number1 + z}y = ${number4}`,
  `${number - z}x + ${number1 - z}y = ${number7}`,
  `${number * z}x - ${number1 * z}y = ${number9}`,
];

let eq2Text = [
  `${number}x - ${number1}y = ${number3}`,
  `${number + z}x + ${number1 + z}y = ${number5}`,
  `${number - z}x - ${number1 - z}y = ${number6}`,
  `${number * z}x + ${number1 * z}y = ${number8}`,
];
